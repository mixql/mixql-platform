...
class TestStubSimpleFuncs extends AnyFunSuite {
  ...
  test("Invoke stub_simple_proc_params function") {
    ...
    val res = gtype.unpack(engine.executeFunc("stub_simple_proc_params", null, gtype.pack(a), gtype.pack(b)))
  ...
  test("Invoke stub_simple_proc_context_params function") {
    ...
    val res = gtype.unpack(engine.executeFunc("stub_simple_proc_context_params", null, gtype.pack(a), gtype.pack(b)))
