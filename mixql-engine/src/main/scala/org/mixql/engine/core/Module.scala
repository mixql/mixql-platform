...
object Module {
  ...
  def sendMsgToServerBroker(
    msg: String)(implicit server: ZMQ.Socket, identity: String, logger: ModuleLogger): Boolean = {
    import logger._
  ...
  def sendMsgToServerBroker(clientAdrress: Array[Byte], msg: messages.Message)(implicit
    server: ZMQ.Socket,
    identity: String,
    clientAddress: Array[Byte],
    logger: ModuleLogger): Boolean = {
  ...
  def readMsgFromServerBroker()(implicit
    server: ZMQ.Socket,
    identity: String,
    logger: ModuleLogger): (Array[Byte], Option[Array[Byte]], Option[String]) = {
    import logger._
...
class Module(executor: IModuleExecutor, indentity: String, host: String, port: Int)(implicit logger: ModuleLogger) {
